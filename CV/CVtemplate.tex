...
% ==================================================================================
\begin{tabular}{p{.85in}>{\hangindent=1em}p{5.65in}<{\raggedright}}
2024 &  \href{https://doi.org/10.1016/j.ress.2023.109770}{``Dependence assessment in human reliability analysis based on cloud model and best-worst method''} (with Changcheng Ji and Wenjiang Liu), \textit{Reliability Engineering \& System Safety}, 224: 109770. \\
...
%==================================================================================$
\begin{tabular}{p{.85in}>{\hangindent=1em}p{5.65in}<{\raggedright}}
Reviewer:&    \textit{IEEE Transactions on Cybernetics}, \textit{IEEE Transactions on Fuzzy Systems}, \textit{IEEE Transactions on Reliability}, \textit{Reliability Engineering \& System Safety}, \textit{Expert Systems with Applications}, \textit{Ocean Engineering}, \textit{Ships and Offshore Structures}, \textit{Kybernetes}, \textit{Soft Computing}, \textit{Journal of Intelligent \& Fuzzy Systems}, \textit{IEEE Access}, \textit{Quality and Reliability Engineering International}, \textit{Journal of Taibah University for Science}\\
\end{tabular}
