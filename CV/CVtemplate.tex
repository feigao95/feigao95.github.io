...
% ==================================================================================
\begin{tabular}{p{.85in}>{\hangindent=1em}p{5.65in}<{\raggedright}}
2024 &  \href{https://doi.org/10.1016/j.eswa.2023.122187}{``An intuitionistic fuzzy weighted influence non-linear gauge system for equipment evaluation under system-of-systems warfare environment''} (with Weikai He and Wenhao Bi), \textit{Expert Systems with Applications}, 238: 122187. \\
