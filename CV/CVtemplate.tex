...
% ==================================================================================
\begin{tabular}{p{.85in}>{\hangindent=1em}p{5.65in}<{\raggedright}}
2024  &  \href{https://doi.org/10.1016/j.oceaneng.2023.116450}{``An integrated linguistic Pythagorean fuzzy decision-making approach for risk analysis of offshore wind turbine''} (with Jinfeng Li, Chencan Bi and Weikai He), \textit{Ocean Engineering}, 291: 116450. \\
...
%==================================================================================$
\begin{tabular}{p{.85in}>{\hangindent=1em}p{5.65in}<{\raggedright}}
Reviewer:&    \textit{IEEE Transactions on Cybernetics}, \textit{IEEE Transactions on Fuzzy Systems}, \textit{IEEE Transactions on Reliability}, \textit{Reliability Engineering \& System Safety}, \textit{Expert Systems with Applications}, \textit{Ocean Engineering}, \textit{Ships and Offshore Structures}, \textit{Kybernetes}, \textit{Soft Computing}, \textit{Journal of Intelligent \& Fuzzy Systems}, \textit{IEEE Access}, \textit{Quality and Reliability Engineering International}, \textit{Journal of Taibah University for Science}, \textit{International Journal of Information Technology \& Decision Making}\\
\end{tabular}
